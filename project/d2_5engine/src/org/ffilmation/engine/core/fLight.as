...
package org.ffilmation.engine.core {
		...
		/**
		* <p>
		* The fLight is an abstract definition of a light that contains generic information such as
		* intensity, size, decay and color. To create a new type of light you must extend this class
		* fLight是灯光的抽象类，他包含例数强度，大小，腐烂，颜色这样共有的信息，如果要创建新类型的灯光，
		* 你必需继承这个类。
		* </p>
		* 
		* <p>
